...
namespace FundamentosNetcore
{
    public partial class Form12ColeccionMultiple : Form
    {
        ...
        {
            //NECESITAMOS ELIMINAR MULTPLES ELEMENTOS DENTRO DE LA LISTA.
            //ELIMINAREMOS MEDIANTE SU INDEX DEBEMOS RECORRER LA COLECCION SELECTEDINDICES
            //RECUPERAMOS CADA INDICE Y ELIMINAMOS CADA ITEM
            int numSelecionados = this.lstElementos.SelectedIndices.Count;
            for (int i = numSelecionados - 1; i >= 0; i--)
            {
